...
html = view.render(page_title: "Reusing View Instance", items: %w[Easy Safe Flexible])
puts html
puts "\n\n"
...
begin
  ...
  puts "Context lines:"
  begin
    puts e.context_lines
  rescue StandardError
    puts "(Context lines not available)"
  end
end
